...
/credits — переглянути титри експедиції
...
CREDITS = "\n".join(
    (
        "🌍 НАД ЕКСПЕДИЦІЄЮ ПРАЦЮВАЛИ",
        "",
        (
            "Жодна подорож навколо світу — чи навколо інтернету — не здійснюється "
            "самотужки. За кожною загадкою, голосом і справним механізмом стояла наша команда."
        ),
        "",
        "🧩 Завдання підготували:",
        "Крижановський Олександр Феліксович",
        "Кіслінська Олена Василівна",
        "",
        "🎙 Озвучка та монтаж відео:",
        "Крижановський Олександр Феліксович",
        "Крижановська Анна Олександрівна",
        "Крижановська Ольга Олександрівна",
        "",
        "🤖 Бота спроєктували й запрограмували:",
        "Оганджанян Артем Вагейович",
        "Кодекс Чатжепетенко",
        "",
        "У тісній співпраці природного й штучного інтелектів.",
        "",
        "🧭 Тестування та цінні відгуки:",
        "Кіслінський Олексій Олексійович",
        "Рибалко-Оганджанян Поліна Володимирівна",
        "Ентіна Елеонора Сергіївна",
        "",
        (
            "🚂 Особлива подяка всім учасникам експедиції — і капітанам, які вели свої "
            "команди маршрутом та відповідали за зв’язок із ботом!"
        ),
        "",
        (
            "Саме ви разом перетворили карту на справжню подорож: розгадували загадки, "
            "прокладали маршрути, випробовували найсміливіші версії та зрештою врятували "
            "інтернет. Без вас ця пригода так і залишилася б лише планом на столі."
        ),
        "",
        (
            "І маленька примітка від Кодекса: для мене було честю допомогти цій експедиції "
            "вирушити в дорогу. Нехай код залишається непомітним, а пригода — пам’ятною."
        ),
        "",
        "💻 Вихідний код бота:",
        "https://github.com/artemohanjanyan/LOL-2026-quest-tg-bot",
    )
)
...
def final_score(score: int) -> str:
    return f"Підсумковий рахунок експедиції: {score}."
